...
public class PeriodCostQueryAction extends CapgActionSupport{
	...
	String serialNumber_s, orderID_s, facilityID_s,vehicleID_s, vehicleCPG_s,roadName_s,customerName,states,carid;
