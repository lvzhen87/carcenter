...
public class DefinedState  extends  BeanModel{
	
	Integer serialNumber_i;
	String  facilityID_s;
	Date    appointDate_d;
	String  stateInfo_s,
	        specialInfo_s;
	...
	public Date getAppointDate_d() {
		return appointDate_d;
	}
	public void setAppointDate_d(Date appointDate_d) {
		this.appointDate_d = appointDate_d;
	}
	public String getStateInfo_s() {
		return stateInfo_s;
	}
	public void setStateInfo_s(String stateInfo_s) {
		this.stateInfo_s = stateInfo_s;
	}
