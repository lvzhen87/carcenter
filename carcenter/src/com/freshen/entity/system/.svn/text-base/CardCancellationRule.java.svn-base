...
public class CardCancellationRule {
	...
	public String getSettime_s() {
		return settime_s;
	}
	public void setSettime_s(String settime_s) {
		this.settime_s = settime_s;
	}
	public Integer getDayseed_i() {
		return dayseed_i;
	}
	public void setDayseed_i(Integer dayseed_i) {
		this.dayseed_i = dayseed_i;
	}
	public Integer getIsEffect_i() {
		return isEffect_i;
	}
	public void setIsEffect_i(Integer isEffect_i) {
		this.isEffect_i = isEffect_i;
	}
