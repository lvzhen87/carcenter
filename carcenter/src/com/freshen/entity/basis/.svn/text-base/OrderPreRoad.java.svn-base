...
public class OrderPreRoad  extends  BeanModel{
	...
	Integer reckonCost_i;//估算费用
	
	
	@Override
	public String toString() {
		return "OrderPreRoad [carNumber_i=" + carNumber_i + ", createDate_t="
				+ createDate_t + ", createUser_s=" + createUser_s
				+ ", endDate_t=" + endDate_t + ", lastUpdateDate_t="
				+ lastUpdateDate_t + ", lastUpdateUser_s=" + lastUpdateUser_s
				+ ", orderID_s=" + orderID_s + ", orderPrepaymentRoadID_s="
				+ orderPrepaymentRoadID_s + ", reckonCost_i=" + reckonCost_i
				+ ", resaveds1_s=" + resaveds1_s + ", resaveds2_s="
				+ resaveds2_s + ", resaveds3_s=" + resaveds3_s
				+ ", resaveds4_s=" + resaveds4_s + ", resaveds5_s="
				+ resaveds5_s + ", roadID_s=" + roadID_s + ", roadName_s="
				+ roadName_s + ", startDate_t=" + startDate_t + ", status_i="
				+ status_i + ", timeQuantum_s=" + timeQuantum_s + "]";
	}
	public Integer getReckonCost_i() {
		return reckonCost_i;
	}
	public void setReckonCost_i(Integer reckonCostI) {
		reckonCost_i = reckonCostI;
	}
