   ...
   <div class="content-box"><!-- Start Content Box -->
		...
		<div class="content-box-header" style="width: 1040px;">
			...
			<ul class="content-box-tabs" >
				...
				<li><a href="./workshopdetailAction" class="tab-content default-tab" >办公车间预订详情</a></li>
	       ...
	       <c:forEach items="${workshoplist}" var="wslist" varStatus="wslistStatus">
			...
			<tr style="${evenOddStyle}">
	           <td>${wslist.orderWorkShopID_s}</td>
	 		   ...
	 		   <td>${wslist.startDate_t}</td>
	 		   <td>${wslist.endDate_t}</td>
			   <!--  <td>${wslist.remark_s } </td>-->
			   <td>
	...
	<div class="dbgrid" style="border: 1px solid #ddd; height: 40px;vertical-align: bottom; display: inline;">
		<!-- 分页 -->
			...
			<div style="display: inline;width: 400px;float:right;padding-right: 5px;">
				<a href="./workshopdetailAction?currentPage=0&orderid=${orderid}" >首页</a>&nbsp;
				<a href="./workshopdetailAction?currentPage=${currentPage-1<=0?0:currentPage-1}&orderid=${orderid}">前一页</a>&nbsp;
				<a href="./workshopdetailAction?currentPage=${currentPage+1>=maxPage?maxPage-1:currentPage+1}&orderid=${orderid}">后一页</a>&nbsp;
				<a href="./workshopdetailAction?currentPage=${maxPage-1}&orderid=${orderid}">末页</a>&nbsp;&nbsp;
				
				<form style="display: inline;" action="./workshopdetailAction" method="post" id="changepage">
