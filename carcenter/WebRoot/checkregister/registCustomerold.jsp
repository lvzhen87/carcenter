...
<html>
 ...
 <div id="man_zone" >
 	...
 	<font color="red" style="margin:0px 0px 0px 10px; font-size: 25px; font-weight:bold;">${errmsg}</font><s:fielderror /><br/>
    <form id="registform" method="post" action="./registerCustomerAction" enctype="multipart/form-data" >
  	<table width="95%" style="margin:0px 0px 0px 5px;">
		<tr>
		   	<td width="15%" id="customerName">&nbsp;&nbsp;公司名称(支持登录)：</td>
		...
		<tr>
			<td>&nbsp;&nbsp;负责人：</td>
		    <td><input id="responsibleUserName_s" name="responsibleUserName_s" type="text" value="${responsibleUserName_s}" onblur="Checkfun.isNull(this,'负责人',80)"/>&nbsp;&nbsp;<font color="red">*</font></td>
			<td>&nbsp;&nbsp;负责人邮箱：</td>
		    <td><input id="responsibleUserEmail_s" name="responsibleUserEmail_s" type="text" value="${responsibleUserEmail_s}" onblur="Checkfun.IsEmail(this,'负责人邮箱')"/>&nbsp;&nbsp;<font color="red">*</font></td>
		</tr>
		<tr>
			<td>&nbsp;&nbsp;身份证号：</td>
		    <td><input id="identifyCard_s" name="identifyCard_s" type="text" value="${identifyCard_s}" onblur="Checkfun.IsIDCard(this,'身份证号')"/>&nbsp;&nbsp;<font color="red">*</font></td>
			<td></td>
		    <td></td>
		</tr>
		 <!--       
  	...
  	<script type="text/javascript">
       	$("#addCustomerUserBt").click(function(){
       		...
       		if(!Checkfun.IsPhone($("#customerUserPhone_s"),'客户电话')){
       			return false;
       		}
       		...
       		if(!Checkfun.isNull($("#responsibleUserName_s"),'负责人',80)){
       			return false;
       		}
       		if(!Checkfun.IsEmail($("#responsibleUserEmail_s"),'负责人邮箱')){
       			return false;
       		}
       		if(!Checkfun.IsIDCard($("#identifyCard_s"),'身份证号')){
       			return false;
       		}
			$("#registform").submit();	
		});
