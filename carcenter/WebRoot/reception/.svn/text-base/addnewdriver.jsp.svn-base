 ...
 <div id="man_zone" style="height: 520px;">
  	...
  	<table width="90%">
  		<tr>
  			...
  			<td width="30%"> <input type="text" id="department_s" name="department_s"  onblur="Checkfun.isNull(this,'部门名称')"/> </td>
  		</tr>
  		<tr>
  			<td class="tor">驾驶员姓名：</td>
  			<td> <input type="text" id="customerUserName_s" name="customerUserName_s"  onblur="Checkfun.isNull(this,'驾驶员姓名')"/> </td>
  			<td class="tor">身份证号：</td>
  			<td > <input type="text" id="identityCard_s" name="identityCard_s"  onblur="Checkfun.isNull(this,'身份证号')"/> </td>
  		</tr>
  		<tr>
  			<td class="tor">手机号码：</td>
  			<td> <input type="text" id="telephone_s" name="telephone_s"  onblur="Checkfun.isNull(this,'手机号码')"/> </td>
  			<td class="tor">驾照号：</td>
  			<td > <input type="text" id="position_s" name="position_s" / onblur="Checkfun.isNull(this,'驾照号')"> </td>
  		</tr>
  		<tr>
  			<td colspan="4" align="center"">
  				<a id="addDriverBt" class="easyui-linkbutton" data-options="iconCls:'icon-add'">添加</a>
  			</td>
  		</tr>
  	</table>
  		...
  		$("#addDriverBt").click(function (){
  			...
  			$.post(
  				"./addDriverInfoAction",
  				{
  					...
  					$.messager.alert('Success',"驾驶员信息添加成功！");
