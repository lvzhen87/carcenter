  ...
  <div id="man_zone">
	...
	<div style="height: 40px;padding: 5px;margin: 0px 5px 0px 10px">
		<h3 style="padding: 0px;margin: 0px;">
  		&gt;&gt;<a href="./recExperiencephoneAction" class="currentFont">对讲机发放</a> &nbsp;&nbsp;&nbsp;
  		&gt;&gt;<a href="./process/callbackinterphone.jsp" >对讲机回收</a>&nbsp;&nbsp;&nbsp;
  		</h3> 
	
		<form id="searchorderform" name="searchorderform" action="./recepExperienceAction" method="post">
				...
				<div>
					...
					<tr>
						<td colspan="8" align="center">
							<a href="./prepareInterphoneAction?orderId=${orderlist.orderID_s}&customerId=${orderlist.customer.customerID_s}" class="easyui-linkbutton">对讲机发放与收回</a>
						</td>
					</tr>
					</table>
