...
$(document).ready(function(){
  ...
  <div id="man_zone" style="height: 515px;width: 100%;">
	  		...
	  		<c:choose>
	  			<c:when test="${empty recVehicleInfo}">
	  				...
	  				<c:forEach items="${recVehicleInfo}" var="vlist" varStatus="status">
				  		...
				  		CPG牌号：<input type="text" name="vehicleCPG" id="vehicleCPG" value="${vlist.vehicleCPG_s }"  onblur="Checkfun.isNull(this,'CPG牌号',80)" readonly="readonly"/><font color="red">*</font>
					...
					<a title="删除" onclick="deletevehicle('${orderId}','${vlist.vehicleCPG_s }')" >
	 ...
	 <form action="./exrecordvehicleAction?orderId=${orderId}" method="post" id="exaddVehicleForm" name="exaddVehicleForm" >
	  		...
	  		车辆颜色：<input type="text" name="color2" id="color2" value=""   onblur="Checkfun.isNull(this,'车辆颜色',80)"/>
	  	<!--  
	  		车卡：<input type="text" name="vehicleID2" id="vehicleID2" onclick="readCardInfo(this)"  onblur="Checkfun.isNull(this,'车卡',80)"/>
	  		授权路面：<input class="easyui-combobox" id="authorizeRoad2Face" style="width: 200px;"	data-options="
		  			url:'roadNameToJson?'+new Date().getTime(),
					method:'get',
					valueField:'id',
					textField:'text',
					multiple:true,
			...
			">
		-->
			失效时间：<input id="invalidate2" name="invalidate2" value="${orderinvalidate }"  type="text" class="easyui-datebox" data-options="formatter:myformatter,parser:myparser" style="width:120px"/><font color="red">*</font>
...
<script type="text/javascript">
		...
		function submitAddVehicleFrom(){
			...
			//	$.messager.alert('提示','请输入车辆颜色!','info');
			//	return false;				
			//}
		...
		function jsAddExVehicle(){
			...
			var text6=" CPG牌号：<input type='text' name='vehicleCPG' id='vehicleCPG' value='${vlist.vehicleCPG_s }'  onblur='Checkfun.isNull(this,'CPG牌号',80)' readonly='readonly'/><font color='red'>*</font>";
			...
			var targetObj = $("#div1").append(text1,text2,text6,text3,text4,text5,text9);
			...
			<tr>
  			...
  			<c:forEach items="${recVehicleInfo}" var="vehiclelist" varStatus="vehicleStatus">
				...
				<tr style="${evenOddStyle}">
					...
					<td>
						<a title="删除" href="./deletevehicleAction?orderId=${orderId}&vehicleCPG2=${vehiclelist.vehicleCPG_s}&vehicleID2=${vehiclelist.vehicleID_s}">
							<img src="images/icons/cross_circle.png" style="cursor:hand;"  alt="删除" />
						</a>
					</td>
				</tr>
